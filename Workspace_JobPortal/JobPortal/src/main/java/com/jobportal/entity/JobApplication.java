...
public class JobApplication {
	...
	public String toString() {
		return "JobApplication [appId=" + appId + ", resume=" + resume + ", resumePath=" + resumePath + ", state="
				+ state + ", interviewFlag=" + interviewFlag + ", interviewLocation=" + interviewLocation
				+ ", interviewTime=" + interviewTime + ", interviewAccepted=" + interviewAccepted + "]";
	}
